...
func (ct *categoryAPI) UpdateCategory(c *gin.Context) {
	...
	err = ct.categoryService.Update(categoryID,UpdateCategory)
	if err != nil {
		c.JSON(500, model.ErrorResponse{Error: err.Error()})
		return
	}
	c.JSON(200, model.SuccessResponse{Message: "category update success"})
	// TODO: answer here
}
...
func (ct *categoryAPI) DeleteCategory(c *gin.Context) {
	...
	c.JSON(200, model.SuccessResponse{Message: "category delete success"})
	// TODO: answer here
}
